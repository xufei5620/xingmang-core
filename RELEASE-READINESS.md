# Release readiness: 0.1.0-rc10 candidate

Status as of 2026-08-24:

- application code and local release candidate: **GO**;
- isolated staging deployment: **GO after the fresh RC10 image gate**;
...
- generate and independently verify a fresh RC10 image/SBOM/vulnerability
...
- deploy all Invoice images under the same RC10 tag and pass real production
...
- create and locally verify the RC10 commit and signed release tag; no GitHub
