# Release readiness: 0.1.0-rc20 eligibility-policy candidate

Status as of 2026-08-25:

- application code and local non-image gates: **GO** (`scripts/verify.ps1` passed);
- isolated staging deployment: **GO after the fresh RC20 image/SBOM gate**;
...
- generate and independently verify a fresh RC20 image/SBOM/vulnerability
...
- deploy all Invoice images under the same RC20 tag and pass real production
...
- create and locally verify the RC20 commit and signed release tag; no GitHub
