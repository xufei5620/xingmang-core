...
it("规则页提供内联入口并保留只读门禁", async () => {
  vi.stubGlobal("fetch", vi.fn(async (input: string) => {
    ...
    return { ok: true, status: 200, json: () => Promise.resolve({ critical_days: 5, warning_days: 10, serious_days: 20, revision: 1, source: "database", updated_at: "2026-08-29T00:00:00Z", updated_by: "bootstrap", reason: "initial" }) } as unknown as Response;
  }));
