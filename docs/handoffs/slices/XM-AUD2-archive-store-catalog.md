...
The `2026-08-30T07:41Z` approval covered the prior receipt-test bytes (`digest=e3ba2f…`).
The test has since been corrected to use savepoints around expected duplicate-key errors
and to keep the disposable transaction usable. Current receipt hash is
`24ae0703fce3c4399dc906961c954e5432e71d24`; recomputed UTF-8 digest is
`caaa33624b93c5d5fc2ee02688bf0d1207d8799f`. The prior approval is superseded; request a
fresh exact input approval for this digest before treating migration/sqlc results as final.
