...
$rc100ReleaseDirectory = 1..99 |
  ForEach-Object { "release\0.1.0-rc100-exact$_" } |
...
pwsh -NoProfile -File .\scripts\verify-release-image-artifacts.ps1 -ReleaseDirectory $rc100ReleaseDirectory -RequireTransferReady -SignedReleaseTag v0.1.0-rc100-signed
...
commit, `releaseName=0.1.0-rc100`, all nine exact `:0.1.0-rc100` image
...
foreach ($candidate in Get-ChildItem -LiteralPath release -Directory -Filter '0.1.0-rc100-exact*') {
  pwsh -NoProfile -File .\scripts\verify-release-image-artifacts.ps1 -ReleaseDirectory $candidate.FullName -RequireTransferReady -SignedReleaseTag v0.1.0-rc100-signed
...
case "$RC100_RELEASE_DIRECTORY" in 0.1.0-rc100-exact[1-9]|0.1.0-rc100-exact[1-9][0-9]) ;; *) echo 'invalid RC100 release directory' >&2; exit 1 ;; esac
