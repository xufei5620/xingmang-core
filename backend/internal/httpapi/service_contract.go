...
type OperationsService interface {
	...
	ListAccountLedgerPage(context.Context, postgresstore.AccountLedgerPageQuery) (postgresstore.AccountLedgerPage, error)
	GetAccountLedgerDetail(context.Context, string, int64) (postgresstore.AccountLedgerDetail, error)
