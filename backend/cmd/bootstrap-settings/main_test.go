...
func TestReadBootstrapSettingsStrict(t *testing.T) {
	...
	body := `{"issuer_name":"主体","minimum_request_minor":20000,"smtp_host":"smtp.qq.com","smtp_port":587,"smtp_from":"invoice@qq.com","smtp_from_name":"发票中心","smtp_starttls":true,"admin_cidrs":["203.0.113.10/32"]}`
