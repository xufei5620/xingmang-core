...
if ($restoreScript -notmatch 'BACKUP_SIGNATURE:\?set BACKUP_SIGNATURE' -or
...
# Unified writer lifecycle, resume health, signed component inventory and rollback
# failure handling are exercised by test-unified-operations.py. Historical restore
# must still verify the signature before decryption and archive parsing.
