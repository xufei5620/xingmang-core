...
git tag -s -a rehearsal/mono-20260910-r2-signed -m 'RC100 image-security release candidate'
...
git verify-tag refs/tags/rehearsal/mono-20260910-r2-signed
...
$tagHeadLines = @(git rev-parse --verify 'refs/tags/rehearsal/mono-20260910-r2-signed^{}')
...
$rc100ReleaseDirectory = 1..99 |
  ForEach-Object { "release\0.1.0-mono-rehearsal2-exact$_" } |
...
pwsh -NoProfile -File .\scripts\release-image-gate.ps1 `
  ...
  -ImageTag 0.1.0-mono-rehearsal2 `
...
pwsh -NoProfile -File .\scripts\verify-release-image-artifacts.ps1 -ReleaseDirectory $rc100ReleaseDirectory -RequireTransferReady -SignedReleaseTag rehearsal/mono-20260910-r2-signed
...
commit, `releaseName=0.1.0-mono-rehearsal2`, all nine exact `:0.1.0-mono-rehearsal2` image
...
foreach ($candidate in Get-ChildItem -LiteralPath release -Directory -Filter '0.1.0-mono-rehearsal2-exact*') {
  pwsh -NoProfile -File .\scripts\verify-release-image-artifacts.ps1 -ReleaseDirectory $candidate.FullName -RequireTransferReady -SignedReleaseTag rehearsal/mono-20260910-r2-signed
...
case "$RC100_RELEASE_DIRECTORY" in 0.1.0-mono-rehearsal2-exact[1-9]|0.1.0-mono-rehearsal2-exact[1-9][0-9]) ;; *) echo 'invalid RC100 release directory' >&2; exit 1 ;; esac
