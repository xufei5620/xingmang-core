...
ALTER ROLE invoice_newapi_payments_reader CONNECTION LIMIT 2;
...
DO $contract$ BEGIN
  EXECUTE format('GRANT CONNECT ON DATABASE %I TO invoice_newapi_payments_reader', current_database());
END $contract$;
